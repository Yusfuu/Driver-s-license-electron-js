import { SUBMIT_DATA } from "../graphql/schema";
...
const Page = () => {
  ...
  const [mutate, { data, loading, error }] = useMutation(SUBMIT_DATA);
        ...
        <div className="mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:px-8 lg:max-w-7xl lg:grid lg:grid-cols-2 lg:gap-24">
          <div>
            ...
            <div className="mt-20">
              ...
              <form
                action="#"
                className="mt-12 sm:max-w-lg sm:w-full sm:flex flex-col gap-10 justify-between"
              >
